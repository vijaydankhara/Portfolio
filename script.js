...
document
  .getElementById("Project-close-button")
...
let Emart = document.querySelector(".Emart");
let Crud = document.querySelector(".CRUD");
let MernStackApp = document.querySelector(".MERN");
...
furnitureapp.addEventListener("click", () => {
  ...
  clientName.innerText = "Skill Code";
  languages.innerText = "node js MongoDB TypeScript";
  preview.innerText = "furniture-app";
  preview.addEventListener("click", () => {
    open("https://github.com/vijaydankhara/Furniture_Project");
  });
  ProjectImage.src = "./assets/Furniture.png";

  description.classList.remove("hidden");
  description.classList.add("flex");
});
Emart.addEventListener("click", () => {
  websiteName.innerText = "Emart";
  clientName.innerText = "Skill Code";
  languages.innerText = "node js MongoDB TypeScript";
  preview.innerText = "Emart";
  preview.addEventListener("click", () => {
    open("https://github.com/vijaydankhara/Emart_Project");
  });
  ProjectImage.src = "./assets/emart.png";
...
Crud.addEventListener("click", () => {
  websiteName.innerText = "CRUD APP";
  clientName.innerText = "Skill Code";
  languages.innerText = "React MongoDB";
  preview.innerText = "CRUD APP";
  preview.addEventListener("click", () => {
    open("https://github.com/vijaydankhara/CRUD");
  });
  ProjectImage.src = "./assets/crud.webp ";

  description.classList.remove("hidden");
  description.classList.add("flex");
});

MernStackApp.addEventListener("click", () => {
  websiteName.innerText = "MernStackApp ";
  clientName.innerText = "Skill Code";
  languages.innerText = "React MongoDB";
...
Ecommerce.addEventListener("click", () => {
  websiteName.innerText = "Ecommerce";
  clientName.innerText = "Skill Code";
  languages.innerText = "HTML CSS";
  preview.innerText = "Ecommerce";
  preview.addEventListener("click", () => {
    open("https://ecommerce-psi-rosy.vercel.app/");
  });
  ProjectImage.src = "./assets/ECOMMERCE.PNG ";
...
document.querySelector(".blog-card-1").addEventListener("click", () => {
  ...
  document.querySelector(".blog-tittle").innerText =
...
document.querySelector(".blog-card-2").addEventListener("click", () => {
  ...
  document.querySelector(".blog-tittle").innerText =
    "Top 10 Tool-kits For Deep Learning In 2020";
...
document.querySelector(".blog-card-3").addEventListener("click", () => {
  ...
  document.querySelector(".Blog-text").innerText =
...
document.querySelector(".blog-card-5").addEventListener("click", () => {
  ...
  document.querySelector(".Blog-text").innerText =
    "web-design,woman-empowerment,designing";
